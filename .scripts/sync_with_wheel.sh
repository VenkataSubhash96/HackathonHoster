...
# curl -s -L "https://raw.githubusercontent.com/bigbinary/HackathonHoster/master/.scripts/sync_with_HackathonHoster.sh" | bash
...
raw_base_url="https://raw.githubusercontent.com/bigbinary/HackathonHoster/master"
declare -a configs=(
  ".eslintrc.js"
  ".eslintignore"
