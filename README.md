[![Build Status](https://bigbinary.semaphoreci.com/badges/HackathonHoster/branches/master.svg?style=shields)](https://bigbinary.semaphoreci.com/projects/HackathonHoster)
...
Follow the instructions mentioned [here](https://github.com/bigbinary/HackathonHoster/blob/master/docs/using_docker.md) to use docker for development.

## Replace HackathonHoster with your project name

Let's say that the project name is `Pump`. Execute the command below to
replace all occurrences of `HackathonHoster` with `Pump`.

```bash
perl -pi -w -e 's/HackathonHoster/Pump/g;' $(git ls-files)
perl -pi -w -e 's/HackathonHoster/Pump/g;' $(git ls-files)
```
...
HackathonHoster is maintained by [BigBinary](https://www.BigBinary.com). BigBinary is a software consultancy company. We build web and mobile applications using Ruby on Rails, React.js, React Native and Node.js.
